...
CREATE TABLE fichas (
	...
	level0 nvarchar (15)  NULL ,
	level1 nvarchar (15)  NULL ,
	level2 nvarchar (15)  NULL ,
	name0 nvarchar (30)  NULL ,
	name1 nvarchar (30)  NULL ,
	name2 nvarchar (30)  NULL ,
	evento nvarchar (30)  NULL ,
	lugar nvarchar (60)  NULL ,
	...
	vivdest int NULL ,
	vivafec int NULL ,
	otros nvarchar (60)  NULL ,
	fuentes nvarchar (255)  NULL ,
	valorloc float NULL ,
	valorus float NULL ,
	fechapor nvarchar (12)  NULL ,
	fechafec nvarchar (12)  NULL ,
	...
	causa nvarchar (25)  NULL ,
	descausa nvarchar (60)  NULL ,
	transporte smallint NOT NULL ,
	Magnitud2 nvarchar (25)  NULL ,
...
CREATE TABLE lev0 (
	lev0_cod nvarchar (15)  NOT NULL ,
	lev0_name nvarchar (30)  NULL, 
	lev0_name_en nvarchar (30)  NULL 
); 

CREATE TABLE lev1 (
	lev1_cod nvarchar (15)  NOT NULL ,
	lev1_name nvarchar (30)  NULL ,
	lev1_name_en nvarchar (30)  NULL ,
	lev1_lev0 nvarchar (15)  NULL 
); 

CREATE TABLE lev2 (
	lev2_cod nvarchar (15)  NOT NULL ,
	lev2_name nvarchar (30)  NULL ,
	lev2_name_en nvarchar (30)  NULL ,
	lev2_lev1 nvarchar (15)  NULL 
); 

CREATE TABLE niveles (
	nivel int NOT NULL ,
	descripcion nvarchar (25)  NULL ,
	descripcion_en nvarchar (25)  NULL ,
	longitud smallint NULL 
); 

CREATE TABLE regiones (
	codregion nvarchar (15)  NOT NULL ,
...
ALTER TABLE wordsdocs WITH NOCHECK ADD 
 ...
 CREATE  INDEX IX_fichas_6 ON fichas(fechano);
...
create table  extensioncodes   (
	...
	code_value nvarchar (30) NOT NULL ,
