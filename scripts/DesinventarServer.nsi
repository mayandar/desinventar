...
; copy IZMADO dll and license to windows\system32
Exec 'copy "$INSTDIR\Server\webapps\DesInventar\WEB-INF\lib\izmjniado.dll" $SYSDIR'
Exec 'copy "$INSTDIR\Server\webapps\DesInventar\WEB-INF\lib\11100417.LIC" $SYSDIR'

CopyFiles $INSTDIR\Server\webapps\DesInventar\WEB-INF\lib\izmjniado.dll $SYSDIR
CopyFiles $INSTDIR\Server\webapps\DesInventar\WEB-INF\lib\11100417.LIC $SYSDIR

CopyFiles $INSTDIR\Server\webapps\DesInventar\WEB-INF\lib\izmjniado.dll $WINDIR
CopyFiles $INSTDIR\Server\webapps\DesInventar\WEB-INF\lib\11100417.LIC $WINDIR
...
CreateShortCut "$SMPROGRAMS\DesInventar Server\DesInventar Monitor.lnk" "$INSTDIR\Server\bin\tomcat5w.exe" "//MS//DesInventar"  "" 2 SW_SHOWMINIMIZED  
