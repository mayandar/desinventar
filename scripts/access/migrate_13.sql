...
-- these statements will most likely fail, just for sanity
alter table event_grouping drop constraint eventos_h_hierarchyFK;
drop table event_grouping;
drop table event_hierarchy;
-- end of optional failures
...
alter table eventos add	    parent text (30);
alter table eventos add		terminal int;
alter table eventos add		hlevel int;

alter table eventos drop constraint eventos_hierarchyFK;
