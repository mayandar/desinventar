...
%JAVA% %JAVA_PARAMS% -classpath "%JAVA_CLASSPATH%" -Dcatalina.home="%CATALINA_HOME%" -Djava.endorsed.dirs=%CATALINA_HOME%\common\endorsed -Djava.io.tmpdir=%CATALINA_HOME%\temp org.apache.catalina.startup.Bootstrap start %2 %3 %4 %5 %6 %7 %8 %9 
