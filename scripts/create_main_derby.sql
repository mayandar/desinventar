...
alter table user_permissions add CONSTRAINT user_permissionsFK2 FOREIGN KEY (country) REFERENCES country (sCountryId) ON DELETE CASCADE ON UPDATE CASCADE;
...
alter table user_subpermissions add CONSTRAINT user_subpermissionsFK2 FOREIGN KEY (country) REFERENCES country (scountryid) ON DELETE CASCADE  ON UPDATE CASCADE;
