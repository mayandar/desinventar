alter TABLE fichas alter column fuentes nvarchar(255)   NULL;

alter TABLE fichas add di_comments ntext;
update fichas set di_comments=isnull(observa,N'') + isnull(observa2,N'') + isnull(observa3,N'');

alter table fichas add uu_id nvarchar(37);
update fichas set uu_id= newid();
