...
<font  class='subTitle'><%=countrybean.getTranslation("XtabGenerator")%>:</font></td>
 
</tr>
</table>
<form name="desinventar" method=post action="crosstab.jsp"  onSubmit="return allSelected(1)">
...
<br>
<table width="100%" border="1" rules="none"  class='IE_Table bs'>
...
<br>
<table border="1" rules="none"  class='IE_Table'>
<tr><td colspan=3 align="center"><P><font class='subtitle'><%=countrybean.getTranslation("DefineCrosstabDimensions")%>:</FONT></P>
</td></tr>
<tr>
<%
...
<td align="middle">
 ...
 align="center" colspan=3><font color="White"><%=countrybean.getTranslation(level==0?"VerticalDimension":"HorizontalDimension")%>:</font></td>
    </tr>
	<tr>
		<td>
...
<INPUT type='hidden'  name="actiontab" id="actiontab" value="crosstab.jsp">
...
<script language="JavaScript">
if (document.desinventar.stat0.selectedIndex<0)
	document.desinventar.stat0.selectedIndex=0;
if (document.desinventar.stat1.selectedIndex<0)
	document.desinventar.stat1.selectedIndex=document.desinventar.stat0.selectedIndex+1;
if (document.desinventar.stat0.selectedIndex==document.desinventar.stat1.selectedIndex)
	document.desinventar.stat1.selectedIndex+=1;
</script>
</td></tr></table>
