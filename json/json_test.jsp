...
<html>
<head>
<title>DesConsultar on-line JSON test-demo page</title>
</head>
...
<tr><td align="left"><h3> JSON  test/demo page</h3></td></tr>
...
<br/>
One of the two standards proposed is an output in JSON format. This page tests the implementation of the JSON format in DesInventar Server 9.xx and above<br>
<br>
The base address for the service in DesInventar is <a href="#">/DesInventar/json/json_service.jsp</a>
...
<br/>
<br/>
<a target='otherWin' href="/DesInventar/json/json_service.jsp?SERVICE=json&REQUEST=getCapabilities&VERSION=1.0.0">REQUEST: GetCapabilities</a><br/>
<br/>
<a target='otherWin' href="/DesInventar/json/json_service.jsp?SERVICE=json&REQUEST=GetDescriptor&VERSION=1.0.0&countrycode=col">REQUEST: GetDescriptor of a database (Colombia)</a><br/>
<br/>
<a target='otherWin' href="/DesInventar/json/json_service.jsp?SERVICE=json&REQUEST=GetDisasterRecord&VERSION=1.0.0&countrycode=col&INTERNAL=1990-0247">REQUEST: GetDisasterRecord (Colombia, record with id=1990-0247)</a><br/>
<br/>
<a target='otherWin' href="/DesInventar/json/json_service.jsp?SERVICE=json&REQUEST=GetDisasterRecordSet&VERSION=1.0.0&countrycode=col&EVENTS=Deslizamiento&GEOCODES=11&LEVEL=1">REQUEST: GetDisasterRecordSet (Colombia, Landslides in Bogota )</a><br/>
<br/>
</td></tr>
<tr><td></td></tr>
...
<li> JSON schema definitions will be made available soon.</li>
