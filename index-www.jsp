...
<tr class="bodydarklight"><td colspan=6 align="center" height="30" valign="middle"><strong>OCEANIA/SOUTH PACIFIC DATABASES</strong></td></tr>
<tr>
    <th>&nbsp;&nbsp;</th>
    <th colspan="2" align="left"><strong><%=countrybean.getTranslation("CountryOrRegion")%><!-- Country or Region --></strong></th>
    <th align="left"><strong><%=countrybean.getTranslation("Period")%><!-- Period --></strong></th>
...
<tr class="bodymedlight bss">
    <td class=bss>&nbsp;</td>
	<% 	cCountry.scountryid="pac";
	cCountry.getWebObject(con);
	sSetDescriptors+=CountryTip.getInstance().getCountryTip(cCountry, countrybean);  %>
	<td nowrap><a class="regionlink" href="/DesInventar/main.jsp?countrycode=<%=cCountry.scountryid%>">
	Pacific Damage and Loss (PDalo)<br/> South Pacific Islands</a>&nbsp;</td>
	<td><a  class="linkText" href="/DesInventar/profiletab.jsp?countrycode=<%=cCountry.scountryid%>"><%=countrybean.getTranslation("Profile")%></a></td>
	<td nowrap><%=cCountry.speriod%>&nbsp;</td>
	<td>SOPAC - SPC Secretariat of the Pacific</td>
	<td><a  class="linkText" onMouseOver="Tip(sTip<%=cCountry.scountryid%>)"  onmouseout="UnTip()"  href="#"><%=countrybean.getTranslation("More Info")%></a></td>
	</tr>
...
<tr class="bss">
	...
	<td><a  class="linkText" href="/DesInventar/profiletab.jsp?countrycode=<%=cCountry.scountryid%>"><%=countrybean.getTranslation("Profile")%></a></td>
	<td nowrap><%=cCountry.speriod%>&nbsp;</td>
	<td>Ministère de l’Equipement de l’Aménagement du territoire et de développement durable, Tunisie, supported by UNDRR/UNDP</td>
	<td><a  class="linkText" onMouseOver="Tip(sTip<%=cCountry.scountryid%>)"  onmouseout="UnTip()"  href="#"><%=countrybean.getTranslation("More Info")%></a></td>
 </tr>
...
<tr><td colspan="6">&nbsp;<br/>&nbsp;</td></tr>
<tr class="bodydarklight"><td colspan=6 align="center" height="30" valign="middle"><strong>EUROPEAN AREA DATABASES</strong></td></tr>
<tr>
    <th>&nbsp;&nbsp;</th>
    <th colspan="2" align="left"><strong><%=countrybean.getTranslation("CountryOrRegion")%><!-- Country or Region --></strong></th>
    <th align="left"><strong><%=countrybean.getTranslation("Period")%><!-- Period --></strong></th>
...
<tr class="bodymedlight bss">
	...
	<td><a  class="linkText" href="/DesInventar/profiletab.jsp?countrycode=<%=cCountry.scountryid%>"><%=countrybean.getTranslation("Profile")%></a></td>
	<td nowrap><%=cCountry.speriod%>&nbsp;</td>
	<td>Sector for Emergency Management - Ministry of Interior, Republic of Serbia </td>
	<td><a  class="linkText" onMouseOver="Tip(sTip<%=cCountry.scountryid%>)"  onmouseout="UnTip()"  href="#"><%=countrybean.getTranslation("More Info")%></a></td>
	</tr>
<tr class="bss">
    <td>&nbsp;</td>
	<% 	cCountry.scountryid="alb";
	cCountry.getWebObject(con);
	sSetDescriptors+=CountryTip.getInstance().getCountryTip(cCountry, countrybean);  %>
	<td nowrap><a class="regionlink" href="/DesInventar/main.jsp?countrycode=alb">
	Albania</a>&nbsp;
    </td>
	<td><a  class="linkText" href="/DesInventar/main.jsp?countrycode=alb"><%=countrybean.getTranslation("Profile")%></a></td>
	<td nowrap><!--%=cCountry.speriod%-->1970-2013&nbsp;</td>
	<td>Civil Defense- Albania</td>
	<td><a  class="linkText" onMouseOver="Tip(sTip<%=cCountry.scountryid%>)"  onmouseout="UnTip()"  href="#"><%=countrybean.getTranslation("More Info")%></a></td>
	</tr>
<tr>
<tr class="bodymedlight bss">
    <td>&nbsp;</td>
	<% 	cCountry.scountryid="tur";
	cCountry.getWebObject(con);
	//sSetDescriptors+=CountryTip.getInstance().getCountryTip(cCountry, countrybean);  
	%>
	<td nowrap><a class="regionlink" href="https://tuaatest.afad.gov.tr/map.jsp">
	Turkey</a>&nbsp;</td>
	<td><a  class="linkText" href="https://tuaatest.afad.gov.tr/map.jsp"><%=countrybean.getTranslation("Profile")%></a></td>
	<td nowrap><!--%=cCountry.speriod%-->1970-2013&nbsp;</td>
	<td>Turkiye Ulusal Afet Arsivi (TUAA) </td>
	<td><a  class="linkText" onMouseOver="Tip(sTip<%=cCountry.scountryid%>)"  onmouseout="UnTip()"  href="#"><%=countrybean.getTranslation("More Info")%></a></td>
	</tr>
<tr class="bss">
    <td>&nbsp;</td>
	<% 	cCountry.scountryid="blr";
	cCountry.getWebObject(con);
	//sSetDescriptors+=CountryTip.getInstance().getCountryTip(cCountry, countrybean);  
	%>
	<td nowrap><a class="regionlink" href="/DesInventar/main.jsp?countrycode=blr">
	Belarus</a>&nbsp;</td>
	<td><a  class="linkText" href="/DesInventar/profiletab.jsp?countrycode=blr"><%=countrybean.getTranslation("Profile")%></a></td>
	<td nowrap><!--%=cCountry.speriod%-->1970-2013&nbsp;</td>
	<td>Belarus - PPRD East </td>
	<td><a  class="linkText" onMouseOver="Tip(sTip<%=cCountry.scountryid%>)"  onmouseout="UnTip()"  href="#"><%=countrybean.getTranslation("More Info")%></a></td>
	</tr>
