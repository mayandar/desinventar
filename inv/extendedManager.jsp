...
<tr>
  ...
  <td>
	...
	<table border="1" cellpadding="0" cellspacing="0" width=450>
	  <tr><td align="center">
      <br>
		<A class='linkText' href='javascript:postTo("extensionManager.jsp")'><%=countrybean.getTranslation("ExtensionManager")%></a><br><br>
		<A class='linkText' href='javascript:postTo("groupManager.jsp")'><%=countrybean.getTranslation("TabManager")%></a><br><br>
		<A class='linkText' href='javascript:postTo("extensionWizard0.jsp")'><%=countrybean.getTranslation("Extension Wizard")%></a><br><br> 
 	  </td></tr>
	</table>
