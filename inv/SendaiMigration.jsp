...
<br/><br/><br/>
<span class=subTitle>Migrating DesInventar Server Database to Sendai format:</span><br>
<br>
</td></tr>
<tr><td align="left">
...
if (isDI)
	{
		dbutils.migrateToSendai(dbCon, con, out, countrybean, sc, dblang);
		%><br><br>Migration completed !<br>
		<%
	}
else
	{
		%><br><br>Your database was already migrated. No action required!<br>
		<%
	}
dbCon.close();
%>
		<a href="/DesInventar/inv/sendaitab.jsp?usrtkn=<%=countrybean.userHash%>">Click here to continue using your Sendai enabled database</a>
</td></tr>
</table>
<br><br>
</body>
