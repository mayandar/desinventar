...
<TR><td width=180 class=bgLight align='right'><%=countrybean.getTranslation("Username")%>: </td><TD><input type="text" name="suserid" maxlength="10" size="10" value="<%=User.suserid %>"><span class="warning">*</span></td></tr>                
