...
<tr>
	...
	<td>  <INPUT type='TEXT' size='31' maxlength='200' name='new_default_value' VALUE="<%=metadata.metadata_default_value%>"></td>
</tr>
<tr>
	<td width=180 class=bgLight align='right'><%=countrybean.getTranslation("Default Value US")%>:</td>
	<td>  <INPUT type='TEXT' size='31' maxlength='200' name='new_default_value_us' VALUE="<%=metadata.metadata_default_value_us%>"></td>
</tr>
