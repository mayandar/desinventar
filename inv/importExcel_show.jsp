...
//System.out.println ("[DI9] opening Excel: "+database);
...
if (inp!=null)
	...
	try
		...
		if (wb!=null && sheet!=null)
			...
			if (nread>=10)
				out.print("<tr><td bgcolor=\"silver\" colspan=6>"+countrybean.getTranslation("There is more data, not displayed.")+"</td></tr>");
			}
		if (nread==0)
			out.print("<tr><td bgcolor=\"silver\">"+countrybean.getTranslation("No Data")+"</td></tr>");
		}
	catch (Exception eex)
	{
	out.print("<tr><td bgcolor=\"silver\">"+countrybean.getTranslation("No Data")+"</td>");
	System.out.println ("[DI9] Error opening/reading Excel: "+eex.toString());
	}	
