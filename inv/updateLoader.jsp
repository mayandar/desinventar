...
<form name="doc_files" action="updateUpload.jsp" METHOD="POST" ENCTYPE="multipart/form-data">
<input type="hidden" name="usrtkn" id="usrtkn" value="<%=countrybean.userHash%>"> 
<table>
<tr><td colspan="2"><strong>DesInventar Update upload facility</strong></td></tr>
<%
