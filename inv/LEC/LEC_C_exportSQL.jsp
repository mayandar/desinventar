...
try	{
	...
	outputTable ("LEC_Categories", out, con, dbType,0);
	outputTable ("LEC_TimeLapse", out, con, dbType,0);
	outputTable ("LEC_IdSuceso", out, con, dbType,0);
	outputTable ("LEC_CostosUnitarios", out, con, dbType,0);
	//outputTable ("LEC_PEconomicas", out, con, dbType,0);
	
	}
catch(Exception e)
	{
	out.println("-- Error in SQL export: "+e.toString()+" -->");
	}	
dbCon.close();
%>
