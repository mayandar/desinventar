...
function refreshFrame()
{
 ...
 if (newFolder)
  ...
  document.getElementById("excelFrame").src="/DesInventar/inv/importExcel_show.jsp?usrtkn=<%=countrybean.userHash%>"+params;
  }
}
...
<tr>
  <td colspan=3><iframe height="160" width="100%"  id="excelFrame" name="excelFrame"></iframe></td>		 
</tr>
<tr>
  <td></td>
