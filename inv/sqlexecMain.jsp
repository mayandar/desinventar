...
int doCommand(Connection con, JspWriter out)
        {
        int nErrors=0;
...
<body>
<br/>
<form  name="sqlexec" action="sqlexecMain.jsp" method="post">
<input type="hidden" name="usrtkn" id="usrtkn" value="<%=countrybean.userHash%>"> 
<FONT size=4><%=countrybean.getTranslation("EnterScript")%></FONT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[MAIN DB]<br>
<TEXTAREA cols=95 name=sql rows=15></TEXTAREA><br>
							...
							for (j=iFirst; j<=meta.getColumnCount(); j++)
								...
								try {
									switch (meta.getColumnType(j))
										...
										case Types.SMALLINT:
										case Types.INTEGER:
											if (rset.getString(meta.getColumnName(j))==null)
												out.print("&nbsp;");
											else
												out.print(Integer.toString(rset.getInt(j)));
											break;
										default:
