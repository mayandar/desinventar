...
<title>DesInventar on-line : <%=countrybean.countryname%> <%=countrybean.getTranslation("CausesManager")%> </title>
</head>
...
{%>
<iframe width="100%" height="500" id="contentFrame" src="causeManager.jsp?usrtkn=<%=countrybean.userHash%>"></iframe>
<%}
else
{%>
