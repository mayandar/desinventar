...
<title>DesInventar on-line : <%=countrybean.countryname%> <%=countrybean.getTranslation("Geographymanager")%> </title>
</head>
...
<table width="1024" border="1" class="pageBackground" rules="none"><tr><td align="center" valign="top">
...
</table><!-- Content goes after this comment -->
<% if (user.iusertype>=20) 
{%>
<iframe width="100%" height="480" id="contentFrame" src="lev0Manager.jsp?usrtkn=<%=countrybean.userHash%>"></iframe>
<%}
else
{%>
