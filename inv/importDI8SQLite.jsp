...
if (sPathVal=="")
   ...
   sPathVal=sPathVal.substring(0,sPathVal.lastIndexOf("/"));
   }
showDialog("/DesInventar/inv/browsefilefrm.jsp?extension=.db&currentPath="+sPathVal, 'setReturnFolder');
}
...
if (document.desinventar.filename.value.length>0)
	{
	if (document.desinventar.filename.value.toLowerCase().indexOf(".db")>0)
	   return true;
	}
...
<form method="post" action="importDI8SQLite2.jsp" name="desinventar" onSubmit="return validateDB();">
...
<!--  TODO:   make the import conditional as below with other databases
