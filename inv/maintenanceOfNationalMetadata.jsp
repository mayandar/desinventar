...
{%>
<iframe width="100%" height="500" id="contentFrame" src="nationalMetadataManager.jsp?usrtkn=<%=countrybean.userHash%>"></iframe>
<%}
else
{%>
<iframe width="100%" height="500" id="contentFrame" src="noaccess.jsp"></iframe>
<%}%>
