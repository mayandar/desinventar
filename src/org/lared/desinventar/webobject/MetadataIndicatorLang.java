...
public class MetadataIndicatorLang extends webObject
{
//    public int dbType=Sys.iDatabaseType;	
	...
	*/
	...
	public MetadataIndicatorLang() {
		super("MetadataIndicatorLang object");
		init();
	}
//--------------------------------------------------------------------------------
	...
	*/
	public int getWebObject(Connection con) 
	{
		...
		try {		
			// SQL_GET
			int f=1;
			sSql = "SELECT * FROM metadata_indicator_lang";
			sSql += " WHERE (indicator_key = ?) AND (metadata_lang = ?)";
	...
	*/
	public int addWebObject(Connection con)
    {
		...
		try {
			// SQL_INSERT
			int f=1;
			sSql = "insert into metadata_indicator_lang (";
			sSql += "indicator_key, metadata_lang, indicator_description)";
			sSql += "VALUES (?, ?, ?)";
			pstmt = con.prepareStatement(sSql);
  	...
  	public int updateWebObject(Connection con)
    {
		...
		try {
			// SQL_UPDATE
			int f=1;
			sSql = "UPDATE metadata_indicator_lang SET ";
